...
risk_file_path = "dataset/updated_ph_levels_risk.csv" 
...
FINAL_MODEL_PATH = WEIGHTS_DIR / "multimodal_cnn_multitask_model_10.pt"
FINAL_STATS_PATH = WEIGHTS_DIR / "multimodal_cnn_multitask_stats_10.json"
BEST_MODEL_PATH = "best_multimodal_cnn_multitask_10.pt"
...
# ============================================================
# 7) MULTIMODAL ARCHITECTURE (CNN + MULTI-TASK)
# ============================================================
...
print("\n--- Starting Multi-Task CNN Training (No Augmentation) ---")
best_ap = -1.0
patience_counter = 0
